...
def build_dashboard_context() -> dict:
    ...
    if weather_view.empty:
        ...
        forecast_summary = {
            "temperature": round(float(weather_view.iloc[0]["temperature_2m"]), 2),
            "precipitation_probability": round(float(weather_view.iloc[0]["precipitation_probability"]), 2),
            "time_label": str(weather_view.iloc[0]["date_label"]),
        }
